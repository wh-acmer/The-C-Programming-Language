...
# 267 "/usr/include/i386-linux-gnu/bits/fcntl.h" 3 4

# 338 "/usr/include/i386-linux-gnu/bits/fcntl.h" 3 4
...
int _flushbuf(int c, FILE *fp) {
    ...
    if ((fp->_flag & (_WRITE | _EOF | _ERR)) != _WRITE) {
        return (-1);
    }



    bufsize = (fp->_flag & _UNBUF) ? 1 : 8192;
    if (fp->base == ((void *)0)) {
